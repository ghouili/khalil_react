...
const SubNav = ({ path, btn_text, ToggleModel }) => {
  return (
    <div className="w-full shadow rounded-md bg-white flex flex-row items-center justify-between py-2 px-6">
      ...
      <button onClick={ToggleModel} className="relative inline-flex items-center justify-center bg-cyan-900 rounded-md p-0.5 group cursor-pointer ">
